...
class Job:
    ...
    Look through the methods and their descriptions to see the tools at your
    disposal. Each has a recommendation as to how to use it in your code.
    ...
    def save_statistic(self, name, value):
        ...
        The README describes three stats we'd like to record for sure:
          - `t_start`
          - `t_end`
          - `duration_data_lost`
